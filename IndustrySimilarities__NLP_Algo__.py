...
stop_words_mine = [ 'goods','nec', '&', 'services', 'stores', 'equipment', 'products', 'services,', 'commercial', "agencies", 
                   "preparation","prepare","agency", "products,", "other", "goods", "national", "protection", "protecting", "bodies",
                   "plans" ,"mineral", "minerals"]
...
def get_similar_industries_ten_flow(given_industry, industry_df, similarity_threshold= 0.0, pool_threshold = 10):
    ...
    data = {'ComparerIndustry':[],'ComparerSubIndustry': [],'Similarity': []}
